...
static func get_date_time_string_utc() -> String:
	var unix_time_stamp = Time.get_unix_time_from_system()
...
# Example: 2022-10-21T12:01:23.6761898Z
#
# @param unix_timestamp: int - Typically from `Time.get_unix_time_from_system()`
...
static func to_date_time(unix_timestamp: int, total_milliseconds_since_epoch: int) -> String:
	...
	var date_time = Time.get_datetime_dict_from_system_from_unix_time(unix_timestamp)
