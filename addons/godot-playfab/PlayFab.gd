...
## [param steam_ticket]: Generated user authentication token[br]
## [param ticket_is_service_specific]: True if ticket was generated using GetAuthTicketForWebAPI(), false if it was generated using GetAuthSessionTicket[br]
...
func login_with_steam(steam_ticket: String, ticket_is_service_specific: bool, create_account: bool, info_request_parameters: GetPlayerCombinedInfoRequestParams) -> void:
	PlayFabManager.client_config.login_type = PlayFabClientConfig.LoginType.LOGIN_STEAM
	PlayFabManager.client_config.login_id = steam_ticket
	
	var request_params = LoginWithSteamRequest.new()
	request_params.TitleId = _title_id
	request_params.CreateAccount = create_account
	request_params.InfoRequestParameters = info_request_parameters
	request_params.SteamTicket = steam_ticket
	request_params.TicketIsServiceSpecific = ticket_is_service_specific
	
	var result = _post(request_params, "/Client/LoginWithSteam", _on_login_with_steam)
...
func _on_login_with_steam(result: Dictionary) -> void:
	var login_result = LoginResult.new()
	login_result.from_dict(result["data"], login_result)
